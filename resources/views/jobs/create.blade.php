...
{{--                                <div class="shrink-0 text-base text-black-400 select-none sm:text-sm/6">workcation.com/</div>--}}
                                <input id="title" type="text" name="title" placeholder="AI Engineer" class="block min-w-0 grow bg-transparent py-1.5 pr-3 pl-1 text-base text-black placeholder:text-gray-500 focus:outline-none sm:text-sm/6 border-2 border-b-gray-700" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-span-full ">
                        ...
                        <div class="flex items-center rounded-md bg-white/5  outline-1 -outline-offset-1 outline-black/10 focus-within:outline-2 focus-within:-outline-offset-2 focus-within:outline-indigo-500">
                            <input id="salary" type="text" name="salary" placeholder="Salary" class="block min-w-0 bg-transparent py-1.5 pr-3 pl-1 text-base text-black placeholder:text-gray-500 focus:outline-none sm:text-sm/6 border-2 border-b-gray-700 ml-3" />
                        </div>
                    </div>
